...
@WebServlet(name="Servlet_test1",value="/Servlet_test1")
public class Servlet_test1 extends HttpServlet  {
	 public void doGet(HttpServletRequest request, HttpServletResponse response)  
	        ...
	        System.out.println("请求方:tr_1601项目");  
	        //设置HTTP连接的URL地址，就是第二个应用的URL。如果在同一个计算机上可以将192.168.1.134变成127.0.0.1或者localhost  
	        String http="http://192.168.1.103:8250/testssm/Setvlet_test2";  
	        ...
	        if(responseCode==HttpURLConnection.HTTP_OK){  
	            System.out.println("请求方:tr_1601项目 "+"\t"+"OK"+responseCode);  
	            //获得服务端的输出流。得到返回的数据  
	            ...
	            //输出所有的数据  
	            System.out.println("请求方:tr_1601项目 "+"\t"+tline);  
	        }else{  
